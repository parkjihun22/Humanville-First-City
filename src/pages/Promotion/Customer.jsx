...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/mdkvrgyg", {
        method: "POST",
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <title>천안 휴먼빌 퍼스트시티 - 관심고객등록</title>
        <meta
          name="description"
          content="천안 휴먼빌 퍼스트시티 관심고객 등록 시 모델하우스 오픈·방문예약, 청약 일정, 현장 위치 등 최신 정보를 가장 먼저 받아보실 수 있습니다."
        />
        <meta name="robots" content="index,follow" />
        <link rel="canonical" href="https://www.abcya4.com/Promotion/Customer" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="천안 휴먼빌 퍼스트시티" />
        <meta property="og:title" content="천안 휴먼빌 퍼스트시티 - 관심고객등록" />
        <meta
          property="og:description"
          content="관심고객 등록으로 모델하우스 방문예약, 청약·분양 일정, 현장 위치 등 주요 안내를 우선 받아보세요."
        />
        <meta property="og:url" content="https://www.abcya4.com/Promotion/Customer" />
        <meta property="og:image" content="https://www.abcya4.com/img/og/customer.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="천안 휴먼빌 퍼스트시티 - 관심고객등록" />
        <meta
          name="twitter:description"
          content="모델하우스 방문예약, 청약 일정, 현장 위치 등 최신 소식을 가장 먼저 받아보세요."
        />
        <meta name="twitter:image" content="https://www.abcya4.com/img/og/customer.jpg" />
        <meta name="twitter:url" content="https://www.abcya4.com/Promotion/Customer" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "천안 휴먼빌 퍼스트시티 - 관심고객등록",
            "url": "https://www.abcya4.com/Promotion/Customer",
            "description":
              "천안 휴먼빌 퍼스트시티 관심고객 등록 시 모델하우스 방문예약, 청약 일정, 현장 위치 등 주요 정보를 우선 제공해 드립니다.",
            "primaryImageOfPage": {
              "@type": "ImageObject",
              "contentUrl": "https://www.abcya4.com/img/og/customer.jpg",
              "width": 1200,
              "height": 630
            },
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "관심고객등록", "item": "https://www.abcya4.com/Promotion/Customer" }
              ]
            }
          })}
        </script>
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>천안 휴먼빌 퍼스트시티</h2>
