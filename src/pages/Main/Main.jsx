...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `브랜드 대단지 스케일`,
    text2: `총 1,541세대 휴먼빌 대단지<br/>
            지하 3층~지상 33층 · 12개동 · 공원형 단지`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 프리미엄`,
    text2: `천안IC·1호선 두정역·KTX 천안아산역 인접<br/>
            부성역(예정), 수도권·서울 접근성 강화`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `생활·의료 인프라 집약`,
    text2: `이마트·신세계백화점·불당 학원가 생활권<br/>
            대형병원·종합의료기관 근거리 위치`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `자연과 함께하는 일상`,
    text2: `성성호수공원 인접·지상 차 없는 단지<br/>
            산책·휴식이 공존하는 쾌적한 주거환경`,
        ...
        <>
            ...
            />
              ...
              <div className={styles.mainImageTextBox}>
                ...
                <div className={styles.mainImageTitleBox}>
                  <div className={styles.mainImageText}>천안이 주목한 미래 가치</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 천안IC·KTX 천안아산역·1호선 두정역 등 뛰어난 광역 교통망<br />
                  - 이마트·신세계백화점·불당 학원가·대형병원 등 생활 인프라 밀집<br />
                  - 성성호수공원 등 자연과 어우러진 쾌적한 주거환경<br />
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="천안 휴먼빌 퍼스트시티아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mdkvrgyg"
              method="POST"
            >
              <label htmlFor="name">
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="천안 휴먼빌 퍼스트시티mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              천안 서북권의 새로운 주거중심<br/> 미래가치 선점<br/>
              브랜드 신뢰 휴먼빌
              <br />
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 천안 휴먼빌 퍼스트시티에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="천안 휴먼빌 퍼스트시티모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="천안 휴먼빌 퍼스트시티브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="천안 휴먼빌 퍼스트시티오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
