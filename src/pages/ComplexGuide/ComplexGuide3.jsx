...
<Helmet>
  ...
  <meta property="og:title" content="천안 휴먼빌 퍼스트시티 - 커뮤니티" />
  <meta
...
<p className={styles.screenReaderOnly}>
  천안 휴먼빌 퍼스트시티의 커뮤니티 페이지에서는 단지 내 다양한 생활 편의시설을 소개합니다.
  피트니스센터, 실내 골프연습장, 작은도서관(북카페), 주민 라운지 등 프리미엄 커뮤니티 공간을 통해
  입주민의 삶의 질을 높이고 소통과 휴식이 공존하는 일상을 완성합니다.
</p>

<div className={styles.textBox}>
  <div>천안의 품격 있는 일상</div>
  <div>천안 휴먼빌 퍼스트시티의 커뮤니티를 만나보세요.</div>
</div>
      ...
      <img
				...
				src={page1}
				alt="천안 휴먼빌 퍼스트시티커뮤니티 안내 -image1"
