...
<Helmet>
  <title>천안 휴먼빌 퍼스트시티 - 인지세 납부 안내</title>
  <meta
    name="description"
...
<h1 className={styles.screenReaderOnly}>
  천안 휴먼빌 퍼스트시티 - 인지세 납부 안내
</h1>
<p className={styles.screenReaderOnly}>
  천안 휴먼빌 퍼스트시티 계약 시 인지세 납부 관련 정보를 확인하세요.
  인지세는 매매계약 체결 시 의무적으로 납부해야 하는 세금으로,
  금액 기준에 따라 세액이 달라집니다. 이 페이지에서는 납부 금액,
  방식, 제출 방법 등을 상세히 안내하여 계약자 여러분의 원활한 진행을 돕습니다.
</p>

<div className={styles.textBox}>
  <div>계약 전 꼭 알아야 할 인지세 안내</div>
  <div>천안 휴먼빌 퍼스트시티, 정확한 정보로 신뢰를 더합니다</div>
</div>
