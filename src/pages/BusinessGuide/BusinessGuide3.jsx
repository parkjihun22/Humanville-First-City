...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
				...
				<meta
					name="description"
					content="천안 휴먼빌 퍼스트시티 분양(청약) 계약을 위한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 빠르게 확인하세요."
				/>
				...
				<meta
					...
					content="천안 휴먼빌 퍼스트시티 계약서류 안내: 신분증·주민등록등본·인감증명서 등 필수 서류와 준비 절차, 유의사항을 확인하세요."
				/>
				...
				<h1 className={styles.screenReaderOnly}>천안 휴먼빌 퍼스트시티 - 계약서류안내</h1>
				...
				<div>천안 휴먼빌 퍼스트시티, 계약서류를 미리 준비하세요.</div>
				</div>


			{/* 이미지에 isImageVisible 상태 적용 */}
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="천안 휴먼빌 퍼스트시티계약서류안내-image1" /> */}
